...
import com.nguyendinhdoan.orderfooddemo.Interface.ItemClickListener;
import com.nguyendinhdoan.orderfooddemo.ViewHolder.MenuViewHolder;
import com.nguyendinhdoan.orderfooddemo.common.Common;
import com.nguyendinhdoan.orderfooddemo.model.Category;
...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category = database.getReference("categorys");
    ...
    private void loadMenu() {
        FirebaseRecyclerAdapter<Category, MenuViewHolder> adapter =
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                    viewHolder.nameMenuTextView.setText(model.getName());
